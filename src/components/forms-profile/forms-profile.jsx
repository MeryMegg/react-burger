...
function FormsProfile() {
	...
	return (
		<form onSubmit={submit} className={cn(styles.form)}>
			...
			/>
			{state.name !== currentUserName || state.email !== currentUserEmail || state.password.length !== 0 ? <div className={styles.buttons}>
				<Button type='secondary' size="medium" onClick={handleClick}>Отмена</Button>
